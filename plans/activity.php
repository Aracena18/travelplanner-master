...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO activities (user_id, start_date, end_date, venue, address, website, email, cost) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->execute([$user_id, $start_date, $end_date, $venue, $address, $website, $email, $cost]);
